...
\begin{document}
    ...
    %----Projects----%
    \section{Projects}
    \href{https://github.com/SatireSage/Multi-threaded-Memory-Allocator}{\faIcon{link} \underline{\textbf{Multi-threaded Memory Allocator:}}} {\sl C, Make\/} \hfill \textbf{Spring 2023}
    \resumeItemListStart{}
    ...
    \resumeItemListEnd{}
    \href{https://github.com/SatireSage/FPGA-UART-Protocol}{\faIcon{link} \underline{\textbf{FPGA UART Protocol Implementation:}}} {\sl VHDL, Modelsim, Altera DE2\/} \hfill \textbf{Spring 2023}
    \resumeItemListStart{}
    ...
    \resumeItemListEnd{}
    \href{https://github.com/SatireSage/Dronee}{\faIcon{link} \underline{\textbf{Drone Controller and System:}}} {\sl Embedded C, Arduino (C++), Beaglebone\/} \hfill \textbf{Fall 2022}
    \resumeItemListStart{}
    ...
    \resumeItemListEnd{}
    \href{https://github.com/SatireSage/FASTrack}{\faIcon{link} \underline{\textbf{FASTrack - Reaction Time Game:}}} {\sl Assembly, Embedded C, Zedboard\/} \hfill \textbf{Summer 2022}
    \resumeItemListStart{}
