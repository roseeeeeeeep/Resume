...
\begin{document}
    ...
    \workItemListStart{}
        \Item{Executed experiments for process and product development, including circuit analysis, \textbf{populating PCBs with SMD soldering}, followed by debugging and verification.}
        \Item{Developed a C program on to produce an ECG signal from a \textbf{low pass filter as a PWM circuit}.}
