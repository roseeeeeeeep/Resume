...
\begin{document}
    ...
    \resumeItemListStart{}
        ...
        \Item{Developped interrupt service routines to handle real-time GPIO events and signal snake movement or screen navigation to ensure proper handling of graphical displays for VGA output display.}
