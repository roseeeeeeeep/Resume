...
\begin{document}
    ...
    \resumeItemListStart{}
        \Item{Designed an interrupt-driven VGA graphics interface on Xilinx Zedboard, with push button input for real-time user interaction.}
        \Item{Developed an interrupt service routine in C++ to handle real-time GPIO events and signal snake movement or screen navigation to ensure proper handling of graphical displays for VGA output.}
        \Item{Thoroughly tested and integrated individual graphical elements, verifying visual accuracy and correct functionality of interrupt routines, ensuring smooth screen updates in response to GPIO inputs on the VGA display.}
    \resumeItemListEnd{}
    {{\color{colorValue}} \underline{\textbf{Graphical 2D Game Application on FPGA with Vivado and Vitis:}}} \hfill \textbf{Spring 2024}
    \resumeItemListStart{}
    \Item{Developed a dual ARM core 2D Graphical Snake Game on Xilinx Zedboard utilizing Vivado and Vitis C/C++ tools, optimizing memory usage and resource utilization for smooth game performance.}
    ...
    \Item{Integrated the interrupt-driven graphical VGA graphical interface with the VGA controller and SoC, creating a seamless embedded system.}
    ...
    \resumeItemListStart{}
        ...
        \Item{Extensively tested the transmitter and receiver components individually, then together with the SoC with testbenches in ModelSim.}
    \resumeItemListEnd{}
