...
\begin{document}
    ...
    \resumeItemListStart{}
    \Item{Developed a 2D Graphical Snake Game on Xilinx Zedboard utilizing Vivado and Vitis C/C++ tools, optimizing memory usage and resource utilization for smooth game performance.}
